...
public class Minvo extends Enemy implements CanMove {
    ...
    public Minvo(int x, int y){
        this.x = x;
        this.y = y;
        image = new ImageIcon(Objects.requireNonNull(getClass().getResource("/sprites/minvo_left1.png"))).getImage();
    }
    @Override
    ...
    public void changeDirection() {
        if(dx == 0 && dy > 0) this.image = new ImageIcon(getClass().getResource("/sprites/minvo_left1.png")).getImage();
        if(dx == 0 && dy < 0) this.image = new ImageIcon(getClass().getResource("/sprites/minvo_right1.png")).getImage();
        if(dx > 0 && dy == 0) this.image = new ImageIcon(getClass().getResource("/sprites/minvo_right1.png")).getImage();
        if(dx < 0 && dy == 0) this.image = new ImageIcon(getClass().getResource("/sprites/minvo_left1.png")).getImage();
    }
}
